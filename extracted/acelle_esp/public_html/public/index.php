...
//if (!(file_exists('../storage/app') && is_dir('../storage/app')) }
...
if (!(file_exists('../storage/framework')&&(is_writable('../storage/framework')) )) {
// && is_dir('../storage/framework') && (is_writable('../storage/framework')))) {
