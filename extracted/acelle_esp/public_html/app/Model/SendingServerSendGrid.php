...
class SendingServerSendGrid extends SendingServer
{
    ...
    /**
     * Get authenticated to SendGrid and return the session object.
     *
     * @return mixed
     */
    ...
    public function setupWebhooks()
    {
        ...
        try {
            ...
            MailLog::info("Response: ".print_r($response,true));
    ...
    public function prepareEmail($message)
    {
        ...
        $mail->addCustomArg("runtime_message_id", $message->getHeaders()->get('X-My-Message-Id')->getFieldBody());
