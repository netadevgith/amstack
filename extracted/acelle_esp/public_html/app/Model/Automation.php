...
class Automation extends Model
{
    ...
    {
        MailLog::info("If you see this text in the log file, it appears that the unused code section is being used, quickly go to app/Model/Automation.php and disable it in updateCache function...");
        // cache indexes
        $index = [
