...
class SendingServerSmtp extends SendingServer
{
    ...
    // Mailu siuntimo standartine acelle funkcija
    /**
    ...
    {
        try {
           // MailLog::info('just trying to send the mail from sendingservermtp model');
...
// hack                MailLog::warning('Sending failed');
