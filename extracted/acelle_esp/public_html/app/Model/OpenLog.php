...
//    }
    ...
    {
        return \Acelle\Model\IpLocation::returnloc($this->ip_address);
    }
    ...
    public static function filter($request)
    {
       ...
       // $query = $query->select([\DB::raw('DISTINCT(subscribers.id)')]);
        ...
        $query = $query->leftJoin('customers', 'customers.id', '=', 'tracking_logs.customer_id')->groupBy('subscribers.id');
