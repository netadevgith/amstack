...
<div class="row">
	...
	@endif
		@if (array_key_exists("threads", Acelle\Model\SendingServer::types()[request()->type]["cols"]))
			<div class="col-sm-6 col-md-4">
				@include('helpers.form_control', [
                    'type' => 'text',
                    'class' => '',
...
<h4 class="text-semibold text-teal-800" style="display: none">{{ trans('messages.sending_quota') }}</h4>

<div class="row boxing" style="display: none">
	<div class="col-md-12">
	...
	<div class="col-md-4">
		...
		<div class="checkbox inline unlimited-check text-semibold">
			<label>
				<input type="checkbox" checked="checked" class="styled">
...
@if ( array_key_exists("bounce_handler_id", Acelle\Model\SendingServer::types()[request()->type]["cols"])
	...
	<h4 class="text-semibold text-teal-800" style="display: none">{{ trans('messages.handlers') }}</h4>
...
<div class="col-sm-6 col-md-4">
	@include('helpers.form_control', [
        ...
        'class' => '',
        'name' => 'sendaddress',
        'label' => 'Send address for server (info@domain.com)',
        'value' => $tracking->sendaddress,
        'placeholder' => "",
        'rules' => Acelle\Model\SendingServer::rules(request()->type)
    ])
	@include('helpers.form_control', [
    ...
    'class' => '',
    'name' => 'tracking',
    'label' => 'Tracking domain for server (domain.com)',
...
<div class="col-sm-6 col-md-4">
	@include('helpers.form_control', [
        ...
        'class' => '',
        'name' => 'servgroup',
        'value' => $server->servgroup,
        'help_class' => 'sending_server',
        'options' => Acelle\Model\ServerGroups::getSelectOptions(),
        'rules' => Acelle\Model\SendingServer::rules(request()->type)
    ])
</div>
<br/><br/>
