                            ...
                            >
								@foreach ($items as $key => $item)
									<tr>
										...
										<td>
											<span class="mr-0">
												@if ($item->cloudmark == null)
												<i class="">Cloudmark pass</i>
													@else
													<i class="">CSI coutch at: {{ $item->cloudmark }}</i>
												@endif
											</span>
										</td>
										<td>
													...
													<ul class="dropdown-menu dropdown-menu-right">
														...
														@if (Auth::user()->customer->can('delete', $item))
															<li>
																...
																<li>
																	<a link-confirm="Are you sure ?" href="{{ action('SendingServerController@export_servers', ["uids" => $item->uid]) }}">
																		<i class="icon-database-export"></i> Export
																	</a>
																</li>
														@endif
													</ul>
