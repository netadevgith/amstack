...
<script>
       ...
       function exportas(type) {
           window.open('/campaigns/{{ $campaign->uid }}/export_redis/'+type);
       }
               </script>
            ...
            <div class="panel panel-flat">
                <div class="panel-body">
                    <div class="chart-container">
                        <div id="chartas" class="chart has-fixed-height" id="d3-bar-horizontal"  data-url="{{ action('CampaignController@chart', $campaign->uid) }}"></div>
                    </div>
                </div>
            </div>
        </div>
