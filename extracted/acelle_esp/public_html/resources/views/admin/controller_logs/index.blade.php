...
@section('page_header')
			...
			<div class="page-title">				
				...
				<h1>
					<span class="text-semibold"><i class="icon-list2"></i>Controller logs</span>
				</h1>				
			</div>
...
@section('content')
				...
				<form class="listing-form"
					data-url="{{ action('Admin\ControllerLogController@listing') }}"
					per-page="{{ Acelle\Model\ControllerLog::$itemsPerPage }}"
				>				
								...
								<div class="filter-box">
									<span class="filter-group">
										...
										<select class="select" name="sort-order">
                                            <option value="controller_logs.created_at">{{ trans('messages.created_at') }}</option>
										</select>										
