...
{{--                                            <span class="text-muted second-line-mobile">{{ trans('messages.sending_server') }}</span>--}}
                                            <span class="no-margin kq_search">{{ $item->user_agent }}</span>
                                            <span class="text-muted second-line-mobile">User agent</span>
                                        </td>
                                        <td>
                                            <span class="no-margin kq_search">{{ $item->LocationName() }}</span>
