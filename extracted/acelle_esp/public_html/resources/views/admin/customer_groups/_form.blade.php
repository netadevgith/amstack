                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        @include('helpers.form_control', [
                                                            ...
                                                            'value' => (is_object($group->customer_group_sending_servers->where('sending_server_id', $server->id)->first()) ? $group->customer_group_sending_servers->where('sending_server_id', $server->id)->first()->fitness : "2000000"),
                                                            'help_class' => 'customer_group',
                                                            'rules' => Acelle\Model\CustomerGroup::rules()
                                                        ])
                                                    </div>
