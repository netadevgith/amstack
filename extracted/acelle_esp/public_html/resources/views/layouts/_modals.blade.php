	...
	<!-- domains test sendout modal form 2020.10.26 -->
	<a style="display: none" type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#send_a_test_domain"></a>
	<div id="send_a_test_domain" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-header bg-teal">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title">{{ trans('messages.send_a_test_email') }}</h4>
			...
			<div class="modal-content">
				<form id="ajax_send_a_test_domain_form" sending-text='<i class="icon-spinner10 spinner position-left"></i> {{ trans('messages.sending_please_wait') }}' action="{{ action('CampaignController@sendTestEmailDomain') }}" method="POST" class="ajax_send_a_test_domain_form form-validate-jquery">
					{{ csrf_field() }}
					<input type="hidden" name="send_test_domain_campaign_uid" />
	...
	<!-- send mail to all servers modal test -->
	<a style="display: none" type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#send_a_test_mass"></a>
	<!-- Basic modal send a test email -->
	<div id="send_a_test_mass" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-header bg-teal">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title">{{ trans('messages.send_a_test_email') }}</h4>
			...
			<div class="modal-content">
				<form id="ajax_send_a_test_mass_form" sending-text='<i class="icon-spinner10 spinner position-left"></i> {{ trans('messages.sending_please_wait') }}' action="{{ action('CampaignController@sendTestEmailMass') }}" method="POST" class="ajax_send_a_test_mass_form form-validate-jquery">
					{{ csrf_field() }}
					<input type="hidden" name="send_test_mass_campaign_uid" />
	...
	<!-- Basic modal send simulation -->
	<div id="simulation_test" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-header bg-teal">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title">{{ trans('messages.send_a_test_email') }}</h4>
			...
			<div class="modal-content">
				<form id="simulation_test_form" sending-text='<i class="icon-spinner10 spinner position-left"></i> {{ trans('messages.sending_please_wait') }}' action="{{ action('CampaignController@CampaignSimulation') }}" method="POST" class="simulation_test_form form-validate-jquery">
					{{ csrf_field() }}
					<input type="hidden" name="simulation_campaign_uid" />
