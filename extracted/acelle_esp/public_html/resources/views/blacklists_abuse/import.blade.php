...
@section('page_header')
    ...
    <div class="page-title">
        <ul class="breadcrumb breadcrumb-caret position-right">
            ...
            <li><a href="{{ action("Blacklist_abuseController@index") }}">{{ trans('messages.blacklist') }}</a></li>
        </ul>
        <h1>
...
@section('content')
        <div class="sub-section">
            ...
            <form action="{{ action('Blacklist_abuseController@post_data') }}" method="POST" class="form-validate-jquery" enctype="multipart/form-data">
                {{ csrf_field() }}
