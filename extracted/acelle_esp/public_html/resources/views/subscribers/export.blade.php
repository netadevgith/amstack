...
@section('content')
                ...
                <div class="row">
                    <div class="col-md-12">
						...
						<div class="">
							<p>Click the "Export" button to start exporting {!! $list->readCache('SubscribeRate', 0) !!} openers.</p>
							<div class="text-left">
								<button class="btn bg-teal mr-10" onclick="exportas()"><i class="icon-check"></i>Export Openers</button>
							</div>
							<br />
						</div>
						<script>
                            function exportas() {
                                window.open('/lists/exportas/' + '{{ $list->id }}','_blank');
                            }
						</script>
